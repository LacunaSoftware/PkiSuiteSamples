...
namespace PkiSuiteAspNetMvcSample.Controllers {
	public class XmlFullSignatureRestPkiController : BaseController {
		...
		public async Task<ActionResult> Index() {
			...
			signatureStarter.SetSignatureElementLocation("//ls:signaturePlaceholder", Lacuna.RestPki.Api.XmlSignature.XmlInsertionOptions.AppendChild, nsm);
