...
namespace PkiSuiteAspNetMvcSample.Controllers {
	...
	public class PrinterFriendlyPadesRestPkiController : BaseController {
		// ####################################################################################################
		...
		private const string VerificationLinkFormat = "http://localhost:54123/CheckPadesRestPki?c={0}";
