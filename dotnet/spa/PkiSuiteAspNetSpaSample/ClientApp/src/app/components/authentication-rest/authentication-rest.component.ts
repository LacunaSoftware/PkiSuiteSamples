...
@Component({
  selector: 'app-authentication-rest',
  templateUrl: './authentication-rest.component.html',
  styleUrls: ['./authentication-rest.component.css']
})
export class AuthenticationRestComponent implements OnInit {
