...
import { OpenPadesSignatureResponse } from '../../api/rest/signature';
import { SignatureRestService } from '../../services/signature-rest.service';

@Component({
  selector: 'app-open-pades-rest',
  templateUrl: './open-pades-rest.component.html',
  styleUrls: ['./open-pades-rest.component.css']
})
export class OpenPadesRestComponent implements OnInit {
