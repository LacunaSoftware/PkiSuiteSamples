...
const { Authentication, CompleteAuth } = require("restpki-client");
const restpki = require("restpki-client");
...
router.get("/session-result", async (req, res, next) => {
	try {
		...
		// Call the start() method, which initiates the authentication.
