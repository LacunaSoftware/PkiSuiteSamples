...
router.get('/', (_req, res, _next) => {
	res.render('xml-nfe-signature-express', { sampleId: SampleDocs.SAMPLE_NFE });
});

/*
 * POST /xml-nfe-signature-express/start
 *
...
router.post('/start', (req, res, next) => {
	...
	signatureStarter.setXmlToSignFromPathSync(StorageMock.getSampleDocPath(SampleDocs.SAMPLE_NFE));
	...
	signatureStarter.start()
		.then((response) => {
			...
			res.render('xml-nfe-signature-express/start', {
				toSignHash,
				digestAlgorithm,
				transferFile,
				certThumb,
...
/*
 * POST /xml-nfe-signature-express/complete
 *
...
router.post('/complete', (req, res, next) => {
	...
	signatureFinisher.setFileToSignFromPathSync(StorageMock.getSampleDocPath(SampleDocs.SAMPLE_NFE));
	...
	signatureFinisher
		...
		.then((result) => {
			...
			res.render('xml-nfe-signature-express/complete', {
