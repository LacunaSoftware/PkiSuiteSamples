...
# class CheckPadesRestController < ApplicationController
#     # GET /check-pades-rest
#     # This route submits a PDF file to REST PKI for inspection of 
#     # its signatures and renders the results.
#     def index
