...
@Controller
public class CadesSignatureRestPkiController {

	/**
	 * This action initiates a CAdES signature using REST PKI and renders the signature page.
	 */
	@RequestMapping(value = "/cades-signature-restpki", method = {RequestMethod.GET})
	public String get(
		...
		// Render the signature page (templates/cades-signature-restpki/index.html.html).
		model.addAttribute("token", result.getToken());
		return "cades-signature-restpki/index";
	}
	 ...
	 */
	@RequestMapping(value = "/cades-signature-restpki", method = {RequestMethod.POST})
	public String post(
		...
		// Render the signature page (templates/cades-signature-restpki/signature-info.html).
		model.addAttribute("signerCert", signerCert);
		model.addAttribute("cmsFile", cmsFile);
		return "cades-signature-restpki/signature-info";
	}
}
