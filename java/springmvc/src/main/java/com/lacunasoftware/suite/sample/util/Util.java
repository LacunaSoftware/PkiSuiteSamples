...
public class Util {
	...
	@Value("${spring.profiles.activate}")
	private static String activeProfile;

	@Value("${rest-pki.accessToken")
	private static String restPkiAccessToken;

	@Value("${rest-pki.endpoint}")
	private static String restPkiEndpoint;

	@Value("${web-pki.license}")
	private static String webPkiLicense;
	...
	public static RestPkiClient getRestPkiClient() {
		...
		// ------------------------------------------------------------------------------------------
		String endpoint = restPkiEndpoint;
		if (endpoint == null || endpoint.length() == 0) {
			endpoint = "http://pki.rest/";
			//endpoint = "https://pki.rest/"; // <--- USE THIS IN PRODUCTION!
		}

		return new RestPkiClient(endpoint, restPkiAccessToken, proxy);
	}
	...
	public static byte[] convertFromBase64String(String contentBase64) {
		return org.apache.commons.codec.binary.Base64.decodeBase64(contentBase64);
	}
