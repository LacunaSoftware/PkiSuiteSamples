...
@Controller
public class PadesSignatureRestPkiController {

	/**
	 * This action initiates a PAdES signature using REST PKI and renders the signature page.
	 */
	@RequestMapping(value = "/pades-signature-restpki", method = {RequestMethod.GET})
	public String get(
		...
		// Render the signature page (templates/pades-signature-restpki/index.html.html).
		model.addAttribute("token", result.getToken());
		return "pades-signature-restpki/index";
	}
	 ...
	 */
	@RequestMapping(value = "/pades-signature-restpki", method = {RequestMethod.POST})
	public String post(
		...
		// Render the signature page (templates/pades-signature-restpki/signature-info.html).
		model.addAttribute("signerCert", signerCert);
		model.addAttribute("signedPdf", signedPdf);
		return "pades-signature-restpki/signature-info";
	}
}
