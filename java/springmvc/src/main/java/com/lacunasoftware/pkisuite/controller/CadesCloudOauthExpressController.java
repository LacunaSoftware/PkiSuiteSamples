 ...
 */
@Controller
public class CadesCloudOauthExpressController {

	// Redirect URL where it's accessed after OAuth flow is finished.
	private final String REDIRECT_URL = "http://localhost:60695/cades-cloud-oauth-express/complete";
	 ...
	 */
	@GetMapping("/cades-cloud-oauth-express")
	public ModelAndView get(
		@RequestParam(value="fileId") String fileToSign
	) {
		return new ModelAndView("/cades-cloud-oauth-express/index");
	}
	 ...
	 * next action.
	 */
	@PostMapping("/cades-cloud-oauth-express/discover")
	public ModelAndView discover(
		...
		model.setCpf(cpf);
		return new ModelAndView("/cades-cloud-oauth-express/discover", "model", model);
	}
	 ...
	 */
	@GetMapping("/cades-cloud-oauth-express/complete")
	public ModelAndView authorize(
		...
		return new ModelAndView("cades-cloud-oauth-express/signature-info", "model", model);
	}
}
