...
class PadesVisualElementsRest {
    ...
    public static function getPdfMark($sampleNumber)
    {
        ...
        switch ($sampleNumber) {
            ...
            case 4:
                // Example #4: Same as example #3, but written vertically on the right side of each
                // page. First, we create the mark object. It contains no elements, being a simple
                // empty box.
                $mark = new PdfMark();
                // Then, we set the mark's position in every page.
                $mark->container = [
