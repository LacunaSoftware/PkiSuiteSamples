...
use Lacuna\RestPki\XmlInsertionOptions;
...
try {
    ...
    $signatureStarter->setSignatureElementLocation("//ls:signaturePlaceholder", 
    ...
    $_SESSION['script'] = 'xml-signature-rest/index.php';
...
<div class="container content">
    ...
    <div class="ls-content">
        ...
        <form id="signForm" action="xml-signature-rest/complete.php" method="POST">
