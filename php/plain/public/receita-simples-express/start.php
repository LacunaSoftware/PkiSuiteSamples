...
use Lacuna\PkiExpress\PadesCertificationLevel;
...
// Comment the line bellow before release.
$signatureStarter->trustLacunaTestRoot = true;
...
$signatureStarter->certificationLevel = PadesCertificationLevel::CERTIFIED_NO_CHANGES_ALLOWED;
...
<div class="container content">
    ...
    <div class="ls-content">
        <form id="signForm" action="receita-simples-express/complete.php?fileId=<?= $fileToSign ?>" method="POST">
            ...
            <a id="tryAgainButton" class="btn btn-primary" href="/receita-simples-express?fileId=<?= $fileToSign ?>">Try Again</a>
        </form>
    </div>
</div>
