 ...
 * signed. It receives the ID of the document and initiates a PAdES signature using REST PKI and
 * returns a JSON with the token, which identifies this signature process, to be used in the next
 * signature steps (see batch-pades-signature-restpki-form.js).
 */
...
// Set the visual representation to the signature. We have encapsulated this code
...
// (see batch-pades-signature-restpki-form.js) and also to complete the signature on the POST action below
