 ...
 * signed. It receives the token, that identifies the signature process. We'll call REST PKI to
 * complete this signature and return a JSON with the saved filename so that the page can render a
 * link to it.
 */
...
// Return a JSON with the file name obtained from REST PKI (the page will use jQuery to decode this
// value).
