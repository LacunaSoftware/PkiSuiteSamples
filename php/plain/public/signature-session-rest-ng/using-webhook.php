...
/*
 * This file initiates a PAdES signature session using REST PKI NG Webhook flow.
 */
...
?>
    ...
    <div class="container content">
        <h2 class="ls-title">Signature Session with REST PKI NG (Webhook flow)</h2>
            <div class="ls-content">
                <p>
                    The REST PKI NG will open on a new tab and after the signature is 
                    ...
                    <br/>
                    For this sample to work, you need to configure the webhook handler public URL at REST PKI NG.
                    <br/>
                </p>
                <button type="button" class="btn btn-primary" onclick="redirectUser()">
                    <i class="fas fa-file-signature"></i> Open REST PKI NG
                </button>
            </div>
    </div>
