 ...
 * signed. It receives the ID of the document and the signer's certificate scripts and initiates a
 * PAdES signature using PKI Express and returns a JSON with the parameters for the client-side
 * signature using Web PKI (see batch-pades-signature-express-form.js).
 */
...
// batch-pades-signature-express-form.js).
$id = $_POST['id'];
...
// "fref://stamp" at the "url" field on the visual representation (see resources/vr.json file or
