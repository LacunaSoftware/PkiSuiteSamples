...
try {
    ...
    $signatureStarter->setXmlToSignFromPath("C://Users//danie//Desktop//Teste//373.804.548.11-Davi_Pires_Reese-Computacao-doc-academica.xml");

    // Set the ID of the element to be signed
    $signatureStarter->toSignElementId = 'Dip84218260860348454560150855550187533840238714';
...
<div class="container content">
    ...
    <h2 class="ls-title">Assinatura Documentação Acadêmica ECPF</h2>

    <div class="ls-content">
        <?php // Notice that we'll post to a different PHP file. ?>
        <form id="signForm" action="xml-doc-signature-rest/FirstSignatureData.php" method="POST">
