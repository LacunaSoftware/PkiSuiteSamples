...
// Create an instance of the CreateOrderRequest class, which contains a class that inherits the
// CertificateParameters class. In this sample, we use a PkiBrazilCertificateParameters class to
// emit a certificate with PKI Brazil parameters.
$createOrderRequest = new CreateOrderRequest();
// Set the certificate authority's id. This authority will generate your certificate. You can have
// a default CAId per application, in that case, there is no need to set this parameter.
...
// Set the certificate parameters class with the desired parameters to your certificate. In this
// sample, we use the ICP-Brazil model, and informed the following fields:
