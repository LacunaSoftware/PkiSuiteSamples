...
try {
    ...
    $signatureStarter->setXmlToSign(StorageMock::getSampleDocPath(SampleDocs::SAMPLE_COD_ENVELOPE));
...
<div class="container content">
    ...
    <div class="ls-content">
        <form id="signForm" action="xml-cod-signature-express/complete.php" method="POST">
