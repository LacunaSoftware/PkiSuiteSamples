...
<div class="container content">
    ...
    <h2 class="ls-title">COD XML signature (COD element) with PKI Express</h2>
    <div class="ls-content">
        <form id="signForm" action="xml-cod-signature-express/start.php" method="POST">
            <?php
            ...
            <div class="form-group">
                ...
                <p>You are signing the <b>COD</b> element of <a href='/download/sample.php?docId=SAMPLE_COD_ENVELOPE'>this sample COD XML envelope</a>.</p>
            </div>
