...
try {
    ...
    $signatureFinisher->setFileToSign(StorageMock::getSampleDocPath(SampleDocs::SAMPLE_COD_ENVELOPE));
...
<div class="container content">
    ...
    <div class="ls-content">
        ...
        <ul>
            ...
            <li><a href="/xml-cod-signature-express/signCodeh.php?fileId=<?= $outputFile ?>">Sign CODEH element</a></li>
        </ul>
    </div>
</div>
