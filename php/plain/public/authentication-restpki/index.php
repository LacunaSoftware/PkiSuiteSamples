<?php
/**
 * This file initiates an authentication with REST PKI and renders the authentication page. The form
 * is posted to another file, authentication-action.php, which calls REST PKI again to validate the
 * data received.
 */
...
// Get an instance of the Authentication class, responsible for starting and completing the
...
// a 22-character case-sensitive URL-safe string, which represents this authentication process.
// We'll use this value to call the signWithRestPki() method on the Web PKI component (see
// signature-form.js below) and also the call the completeWithWebPki() method on the complete.php
// file. This should NOT be mistaken with the API access token. We have encapsulated the security
...
<div class="body-content container">
    ...
    <form id="authForm" action="authentication-restpki/complete.php" method="POST">
