...
var batchSignatureRestPkiForm = (function () {
    ...
    function startSignature(step, done) {
        ...
        $.ajax({
            url: '/batch-signature-restpki/start?id=' + step.docId,
            method: 'POST',
            dataType: 'json',
    ...
    function completeSignature(step, done) {
        ...
        $.ajax({
            url: '/batch-signature-restpki/complete?token=' + step.token, // The signature process token is guaranteed to be URL-safe.
            method: 'POST',
            dataType: 'json',
