...
var batchSignatureRestForm = (function () {
        ...
        for (var i = 0; i < formElements.documentsIds.length; i++) {
            ...
            formElements.docList
                .append($('<li />')
                    .append($('<a />')
                        .text('Document ' + docId)
                        .attr('href', '/download/doc.php?fileId=' + docId)));
        }
    ...
    function startBatch() {
        ...
        //
        //    1. Start the signature    : Call batch-pades-signature-restpki/start to start the signature
        //                                and get the signature process token.
        //    2. Perform the signature  : Call Web PKI's method signWithRestPki with the token.
        //    3. Complete the signature : Call batch-pades-signature-restpki/complete to notify that the
