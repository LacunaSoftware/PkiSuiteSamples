...
// Get an instance of the Authentication class, responsible for contacting
// PKI Express to start and compute the authentication.
...
// - nonce:           The nonce to be signed. This value is also used on
//                    "complete" action;
